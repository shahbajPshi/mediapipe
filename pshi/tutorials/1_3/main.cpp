...
/// I also load the graph from a text file graph.pbtxt in this example
/// I use the relative path to graph.pbtxt
/// Run this from mediapipe root directory, like this
/// bazel build --define MEDIAPIPE_DISABLE_GPU=1   //mediapipe/pshi/tutorials/1_3:1_3
/// then use this: bazel-bin/mediapipe/pshi/tutorials/1_3/1_3
#include <iostream>
#include <string>
...
mediapipe::Status run() {
    ...
    string pathGraph("mediapipe/pshi/tutorials/1_3/graph.pbtxt");
    string protoG;
