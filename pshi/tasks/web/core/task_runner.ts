...
import {Acceleration} from '../../cc/core/proto/acceleration_pb';
import {BaseOptions as BaseOptionsProto} from '../../cc/core/proto/base_options_pb';
import {ExternalFile} from '../../cc/core/proto/external_file_pb';
import {BaseOptions, TaskRunnerOptions} from './task_runner_options';
import {createMediaPipeLib, FileLocator, GraphRunner, WasmMediaPipeConstructor} from '../../../../mediapipe/web/graph_runner/graph_runner';
import {SupportModelResourcesGraphService} from '../../../../mediapipe/web/graph_runner/register_model_resources_graph_service';
